  ...
  return (
    ...
    >
      <div style={imageContainerStyle}>
        {hasDiscount && (
          <div style={badgeStyle}>{discountPercent}%</div>
        )}
        <div style={overlayStyle}>
          {isHovered && (
            <div style={hoverInfoStyle}>
              <div style={{ fontSize: watchaTokens.typography.fontSize.xs, color: watchaTokens.colors.text.primary }}>
                {title}
              </div>
              <div style={{ fontSize: watchaTokens.typography.fontSize.xs, color: watchaTokens.colors.text.secondary, marginTop: '4px' }}>
                예상 ★ {rating}
              </div>
            </div>
          )}
